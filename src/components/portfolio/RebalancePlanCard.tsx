...
export function RebalancePlanCard({
  ...
  return (
    <>
      <Card className={needsRebalance ? "border-warning/30" : ""}>
        <CardHeader>
            ...
            {plan.map((a) => {
              ...
              return (
                <li
                  ...
                  className="flex flex-col gap-2 rounded-lg border border-border/60 bg-surface-2/40 px-3 py-2.5 text-sm"
                >
                  <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2">
                    <div className="flex items-start gap-2 min-w-0">
                      ...
                      <div className="min-w-0">
                        <div className="font-medium mono">
                          {a.action} {a.asset}
                          <span className="text-text-muted font-normal ml-2">~{fmtUsd(a.suggestedUsdc)}</span>
                        </div>
                    ...
                    <div className="flex items-center gap-2 shrink-0 sm:flex-col sm:items-end">
                      <div className="text-[10px] mono uppercase tracking-widest text-text-muted">
                        ...
                        <span className={cn("ml-2", a.driftPct > 0 ? "text-success" : "text-danger")}>
                          ({a.driftPct > 0 ? "+" : ""}
                      ...
                      {a.action === "SELL" && (
                        <a href="/positions" className="btn text-xs py-1 px-2.5">
                          Positions
                        </a>
                      )}
                    </div>
